...
// Debug Flags
export const DEFAULT_DEBUG_ANIM = false;              // Log animation internals
export const DEFAULT_DEBUG_SAMPLE_EVERY = 500;        // Log every N frames when debug is on

// Diagnostics
export const DEFAULT_DIAGNOSTICS_ENABLED = false;    // Toggle runtime diagnostics logging
export const DEFAULT_DIAGNOSTICS_SAMPLE_MS = 1000;   // How often to sample (ms)
